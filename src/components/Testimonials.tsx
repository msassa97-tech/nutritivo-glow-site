    ...
    <section className="py-20 px-0 sm:px-4 relative overflow-hidden bg-card">
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative w-full mt-10 px-2 sm:px-4">
          <div
            className="flex overflow-x-auto scroll-smooth [scrollbar-width:none] [-webkit-overflow-scrolling:touch] py-5 gap-4"
            ref={carouselRef}
          ...
          >
            {testimonialImages.map((testimonial) => (
              ...
              >
                <div className="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 w-[280px] md:w-[350px] bg-background">
                  <img
                    src={testimonial.src}
                    alt={testimonial.alt}
          ...
          <div className="flex justify-end gap-2 mt-4 pr-2 sm:pr-4">
            <button
              className="h-10 w-10 rounded-full bg-primary flex items-center justify-center disabled:opacity-50 hover:bg-primary/80 transition-colors duration-200"
