...
const VideoSection = () => {
  ...
  useEffect(() => {
    // Recarrega o script do Instagram para processar o embed
      ...
      <div className="container max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="relative rounded-3xl max-w-xl mx-auto overflow-visible animate-scale-in">
          <blockquote 
            ...
            data-instgrm-permalink="https://www.instagram.com/reel/DNl1faooYdx/?utm_source=ig_embed&amp;utm_campaign=loading" 
          ...
          >
            <div style={{ padding: '16px' }}>
              <a 
                href="https://www.instagram.com/reel/DNl1faooYdx/?utm_source=ig_embed&amp;utm_campaign=loading" 
                style={{ 
                  background: '#FFFFFF',
                  lineHeight: 0,
                  padding: 0,
              ...
              <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  A post shared by Luana Salvino | Nutricionista (@luanasalvinonutri)
                </a>
              </p>
            </div>
          </blockquote>
