  ...
  return (
    <div className="w-full max-w-[56rem] p-8">
      <div className="grid gap-20 md:grid-cols-2">
        {/* Images */}
        <div className="relative w-full h-96 md:h-[24rem]" style={{ perspective: '1000px' }} ref={imageContainerRef}>
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex gap-6 pt-12 md:pt-0">
            <button
              className="w-[2.7rem] h-[2.7rem] rounded-full flex items-center justify-center cursor-pointer transition-colors duration-300 border-0"
              onClick={handlePrev}
              style={{
